...
serial('treeJson should generate a correct tree with extensions png files', async t => {
  ...
  t.truthy(file.name === 'img.png', 'file name should to be img.png')
  t.truthy(file.type === constants.FILE, 'img.png type should to be file')
  t.truthy(dir1.type === constants.DIRECTORY, '/root-path-extensions/dir-1 type should to be directory')
  t.truthy(dir2.type === constants.DIRECTORY, '/root-path-extensions/dir-2 type should to be directory')
})
...
serial('treeJson should generate a correct tree with extensions txt files', async t => {
  ...
  t.truthy(file1.name === 'file1.txt', 'file name  should to be file1.txt')
  t.truthy(file1.type === constants.FILE, 'file1.txt type should to be file')
  t.truthy(file2.name === 'file2.txt', 'file name should to be file2.txt')
  t.truthy(file2.type === constants.FILE, 'file2.txt type should to be file')
  t.truthy(dir1.type === constants.DIRECTORY, '/root-path-extensions/dir-1 type should to be directory')
  t.truthy(dir2.type === constants.DIRECTORY, '/root-path-extensions/dir-2 type should to be directory')
})
serial('treeJson should generate a correct tree with extensions txt and png files', async t => {
  ...
  t.truthy(file1.name === 'file1.txt', 'file name  should to be file1.txt')
  t.truthy(file1.type === constants.FILE, 'file1.txt type should to be file')
  t.truthy(img.name === 'img.png', 'file name should to be img.png')
  t.truthy(img.type === constants.FILE, 'img.png type should to be file')
  t.truthy(file2.name === 'file2.txt', 'file name should to be file2.txt')
  t.truthy(file2.type === constants.FILE, 'file2.txt type should to be file')
  t.truthy(dir1.type === constants.DIRECTORY, '/root-path-extensions/dir-1 type should to be directory')
  t.truthy(dir2.type === constants.DIRECTORY, '/root-path-extensions/dir-2 type should to be directory')
